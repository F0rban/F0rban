...
const ACTIVITY_POOL: ActivityTemplate[] = [
  ...
  { kind: "workflow.run", title: "Atlas answer pipeline completed", detail: "1,204 answers · p95 2.31s · 7.1% fell back to search", entityType: "workflow", entityId: "w-atlas-answer", cost: 44.91, weight: 7 },
  { kind: "workflow.run", title: "Support triage completed", detail: "312 tickets · 93% routed · 21 escalated", entityType: "workflow", entityId: "w-support-triage", cost: 6.52, weight: 6 },
  { kind: "workflow.run", title: "Weekly market brief published", detail: "Issue #21 · fact-check flagged 1 claim · audio digest attached", entityType: "workflow", entityId: "w-signal-brief", cost: 0.2995, weight: 3 },
