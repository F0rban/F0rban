...
const ACTIVITY_POOL: ActivityTemplate[] = [
  ...
  { kind: "duel.decided", title: "Claude Sonnet 4.5 won: Rate limiter edge cases", detail: "Code review · identical findings, Sonnet gave a failing test case", entityType: "duel", entityId: "d-code-review-5", cost: 0.048, weight: 7 },
  { kind: "duel.decided", title: "Claude Haiku 4.5 won: Priority triage, 80 tickets", detail: "Classification · same labels, eight times faster", entityType: "duel", entityId: "d-classification-4", cost: 0.002, weight: 6 },
  { kind: "verdict.changed", title: "Summarisation flipped to Claude Sonnet 4.5", detail: "GPT-5.1 led until September; Sonnet has won the last seven", entityType: "duel", entityId: null, cost: null, weight: 3 },
